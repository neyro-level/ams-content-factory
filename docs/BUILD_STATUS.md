...
- **Current task:** W5.2 — organizations UI (`DONE`); next: W5.3 brands UI.
- **Last verification:** 2026-08-12: Prisma validation, lint, formatting, typecheck, 26 unit tests,
  28 integration contracts, 5 browser E2E flows and production build passed.
...
- **NOT_IMPLEMENTED:** brand UI, real product workflows, live provider runtime, durable scheduling,
