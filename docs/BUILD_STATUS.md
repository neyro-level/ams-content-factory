...
- **Current Wave:** 7 — Media.
- **Current Task:** W7 — assets, storage, render/video states, FFmpeg and Remotion.
...
- **Last verification:** full Wave 6 quality gate passed on 2026-08-11: lint, formatting, typecheck, unit, 11 integration contracts, E2E and production build.
...
- **Next step:** implement Wave 7 Media. No production deploy.
