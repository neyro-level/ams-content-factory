...
- **Current Wave:** 6 — Video planning.
- **Current Task:** W6 — recipes, validation, storyboard and visual jobs.
...
- **Last verification:** full Wave 5 quality gate passed on 2026-08-11: lint, formatting, typecheck, unit, 10 integration contracts, E2E and production build.
...
- **Next step:** implement Wave 6 Video planning. No production deploy.
