...
- **Current task:** W5.3 — brands UI (`DONE`); next: W5.4 application navigation.
...
- **NOT_IMPLEMENTED:** application navigation, real product workflows, live provider runtime, durable
